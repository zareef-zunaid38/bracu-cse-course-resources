...
The course primary. All lecture slides map directly to its chapter/section numbers. Read the relevant sections for every topic — the questionnaire strategy explicitly says moderate-difficulty questions require reading the textbook (not just slides).

**Modern Operating Systems** — Tanenbaum (4th ed.)
Supplementary. Useful when Silberschatz explanations feel abstract. Tanenbaum writes from an implementation perspective; stronger for understanding *why* design decisions were made.
...
Base path: `CSE321/docs/`

- **`CSE321_outline_summer2026.md`** — Current semester course outline (Summer 2026). Contains topic schedule, assessment dates, and CO mappings.
- **`CSE321_questionnaire_prep_strategy.md`** — Faculty-provided exam preparation strategy. States what question difficulty levels require (slides only vs. textbook reading). Read before starting midterm prep.
- **`CSE321_course_outline.md`** — Official OBE course outline.

## Textbooks (not hosted in this repo)

- Silberschatz, Galvin & Gagne, *Operating System Concepts* (10th ed.)
- Tanenbaum, *Modern Operating Systems* (4th ed.)
- Arpaci-Dusseau, *Operating Systems: Three Easy Pieces* (OSTEP) — free at ostep.org
