...
**File Systems (Topics 20–23)** — the most consistent, calculation-heavy section, present in all 4 recent sittings. Recurring exact question types, matching what's now in [[CSE321_m5_file_systems]]:
...
Items 1–7 map directly onto the Key Skills already built out in [[CSE321_m5_file_systems]] and [[CSE321_m6_memory_management]] during this session's slide/practice-sheet audit — those two notes are now the highest-leverage study material for this exam. Items 8, 10, and 12 are covered but genuinely lower-yield; don't let Protection/Security's thorough taxonomy coverage in [[CSE321_m7_protection]]/[[CSE321_m8_security]] crowd out time that should go to File Systems/Memory Management drilling, since the actual mark distribution favors the latter two by a wide margin in every recent sitting.
