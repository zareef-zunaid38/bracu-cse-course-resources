...
- Positional constraints ("contains 0 in every second and third position") — same style as the Quiz 1 DFA positional questions per [cse331_exam_notes](../cse331_exam_notes.md), just now expressed as a CFG.
...
**Lower probability but still syllabus-legal (per [cse331_topics](../topics/cse331_topics.md), not yet PYQ-confirmed):**
