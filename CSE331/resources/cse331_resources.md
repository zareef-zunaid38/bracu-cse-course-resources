...
HDD copy: `/media/zareef_zunaid/Zareef-Work/Course-Library/cse/cse331/books/Sipser_Introduction_to_the_Theory_of_Computation_3e.pdf`
...
> Partial gap-fill: [[../lecture-notes/CSE331_lecture_01_prelims|Lecture Notes]] (2026-06-08 to 2026-06-29) transcribed from a classmate's handwritten notes, status `needs-review`. Covers Topics 1–3 (Preliminaries through NFA→DFA subset construction).

## HDD Lecture Notes
`Course-Library/cse/cse331/lecture-notes-hdd/` — Turing Machines (covers topics 17–19), by Rafiad Sadat Shahir (RSS), TNF-shared. Two versions kept, content differs:
...
- **Pumping Lemma extras (TNF-shared, 2026-08-03):** cited as secondary/supplementary material in [[../lecture-notes/CSE331_lecture_11_2026-07-21|Lecture 11]]. All three filed on HDD at `Course-Library/cse/cse331/practice/`:
...
- HDD: RSS lecture note (both versions — see `HDD Lecture Notes` above). Covers TM 7-tuple definition, state-diagram notation, worked TM constructions (contains-11, 0ⁿ1ⁿ, w#w), configurations, Church-Turing thesis, Turing recognizable vs. decidable, A_DFA decidability, Universal TM (A_TM), and the Halting Problem undecidability proof (diagonalization/self-reference technique).
