...
Uses the same transition notation as [[CSE331_lecture_15_2026-08-17|Lecture 15]]: $a, b \to c$ means read input $a$ (or $\varepsilon$), pop $b$ (or $\varepsilon$), push $c$ (or $\varepsilon$).
