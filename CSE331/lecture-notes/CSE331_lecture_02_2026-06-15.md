...
status: reviewed
source: "Transcribed from a classmate's handwritten notes (scanned PDF, 2026-07-01). Original discarded after user cross-check. Content re-verified 2026-09-05 (all 8 worked DFA constructions traced transition-by-transition against their stated semantics/test cases) — no errors found."
---

# CSE331 — Lecture 2: DFA Definition

*Starts partway through notebook page 6 (undated, continuing directly from [[CSE331_lecture_01_prelims]]) through page 13.*
...
stateDiagram-v2
    ...
    classDef accepting stroke-width:3px
```
*(q2 = started with 0, last symbol 0 — accepting. q4 = started with 0, last symbol 1. q3 = started with 1, last symbol 1 — accepting. q5 = started with 1, last symbol 0. q1 = start. Confirmed against the regex for the same language in [[CSE331_lecture_07_2026-07-06]]: $0\Sigma^*0 \cup 1\Sigma^*1 \cup 1 \cup 0$.)*
