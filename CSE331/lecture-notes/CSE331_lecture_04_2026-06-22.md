...
stateDiagram-v2
    ...
    classDef accepting stroke-width:3px
```
*(d/e wired as the standard odd-1s toggle — same construction as [[CSE331_lecture_02_2026-06-15]]'s odd-number-of-1s example, applied here since $L_2$'s property is named but the source only says "2-state machine.")*
