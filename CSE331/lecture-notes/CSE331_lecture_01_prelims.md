...
status: reviewed
source: "Transcribed from a classmate's handwritten notes (scanned PDF, 2026-07-01). Original discarded after user cross-check. Content re-verified 2026-09-05 (definitions and marks breakdown checked against index.md and standard theory) — no errors found."
---

# CSE331 — Lecture 1: Preliminaries

*Date approximate — first pages of the notebook carried no date stamp; placed before the first dated page (2026-06-15). Covers notebook pages 1–5; page 6 onward (Finite Automaton introduction) is filed under [[CSE331_lecture_02_2026-06-15]] since it flows directly into the dated content with no topic break.*
...
*(Cross-checked against [[cse331_topics]] / `index.md`, which independently records the same breakdown.)*
