...
Fold the finished set + verified answers into the Final revision guide (`Course-Library/cse/cse370/revision-guides/`, per `project_revision_guide_workflow`) as a "Mock Final" section.
